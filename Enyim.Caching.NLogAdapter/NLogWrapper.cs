...
namespace Enyim.Caching
{
	internal class NLogWrapper : Enyim.Caching.ILog
	{
		...
		{
			this.log.Debug(exception, (message ?? String.Empty).ToString());
		}
		...
		{
			this.log.Info(exception, (message ?? String.Empty).ToString());
		}
		...
		{
			this.log.Warn(exception, (message ?? String.Empty).ToString());
		}
		...
		{
			this.log.Error(exception, (message ?? String.Empty).ToString());
		}
		...
		{
			this.log.Fatal(exception, (message ?? String.Empty).ToString());
		}
